	...
	public partial class Form1 : Form
	{
		...
		private void soumettre_Click(object sender, EventArgs e)
		{
			...
			try
			{
				...
				;
				MessageBox.Show($"{products.Count} fichiers de remplacement crée sur le bureau!", "Fichiers créé sur le bureau!", MessageBoxButtons.OK, MessageBoxIcon.Information);
			}
			catch (Exception ex)
			{
